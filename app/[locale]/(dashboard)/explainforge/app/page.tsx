            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                <header className="space-y-4">
                    <div className="flex items-center gap-2 text-emerald-400 font-bold tracking-widest text-[10px] uppercase">
                        <Sparkles className="w-3.5 h-3.5 animate-pulse" /> Career-Ready Explanation Engine
                    </div>
                    ...
                    <p className="text-slate-400 text-lg max-w-2xl font-medium tracking-tight">
                        Transform your source code into a professional interview-ready narrative. Real humans explain, machines analyze.
                    </p>
                </header>
                ...
                <Button 
                    ...
                    className={`rounded-2xl px-6 border-white/10 hover:bg-white/5 text-xs font-bold uppercase tracking-widest h-14 flex items-center gap-3 transition-all ${showHistory ? 'bg-indigo-500/20 border-indigo-500/50 text-indigo-400' : 'text-slate-400'}`}
                >
