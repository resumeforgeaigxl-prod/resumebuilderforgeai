    ...
    <div className="space-y-8 pb-20">
      <header className="flex justify-between items-end">
        <div>
          ...
          <h1 className="text-4xl font-bold tracking-tighter text-white">AI Systems Health</h1>
          <p className="text-slate-400 mt-2 text-lg">Real-time oversight of ResumeForgeAI AI infrastructure.</p>
        </div>
        <Badge className="bg-emerald-500/10 text-emerald-400 border-emerald-500/20 px-3 py-1 rounded-full text-xs animate-pulse">
          Systems Operational
        </Badge>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="p-6 bg-white/[0.02] border-white/5 space-y-4">
          ...
          <div>
            <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Total Token Usage</p>
            <h3 className="text-2xl font-bold text-white mt-1">1.25M</h3>
          </div>
        </Card>
        <Card className="p-6 bg-white/[0.02] border-white/5 space-y-4">
          ...
          <div>
            <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Estimated Cost</p>
            <h3 className="text-2xl font-bold text-white mt-1">$24.50</h3>
          </div>
        </Card>
        <Card className="p-6 bg-white/[0.02] border-white/5 space-y-4">
          ...
          <div>
            <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Model Distribution</p>
            <h3 className="text-2xl font-bold text-white mt-1">Gemini 2.0</h3>
          </div>
        </Card>
        <Card className="p-6 bg-white/[0.02] border-white/5 space-y-4">
          ...
          <div>
            <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Security Anomalies</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <Card className="lg:col-span-2 p-6 bg-white/[0.02] border-white/5 space-y-6">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-bold text-white flex items-center gap-2">
              <Database className="w-5 h-5 text-purple-400" /> Live AI Interaction Log
            </h2>
              ...
              <tbody className="divide-y divide-white/5">
                {logs.map((log) => (
                  <tr key={log.id} className="group hover:bg-white/[0.01]">
                    <td className="py-4 font-bold text-white">{log.module}</td>
                    <td className="py-4 text-slate-400">{log.user}</td>
                    <td className="py-4 font-mono text-indigo-400">{log.tokens.toLocaleString()}</td>
                    <td className="py-4">
                    ...
                    <td className="py-4 text-slate-500 text-xs">{log.time}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      <Card className="p-6 bg-red-500/5 border border-red-500/20 rounded-3xl flex items-center gap-6">
        ...
        <div>
          <h4 className="font-bold text-white">System Advisory</h4>
          <p className="text-sm text-slate-400">ElevenLabs API key #3 is approaching rate limit (92%). Rotation engaged.</p>
        </div>
      </Card>
    </div>
  );
