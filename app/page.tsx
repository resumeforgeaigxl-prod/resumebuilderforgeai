...
import { ArrowRight, FileText, Sparkles, Zap, Shield, Target, Layout, Upload, CheckCircle2, Lock, TrendingUp, XCircle, BrainCircuit } from 'lucide-react';
        ...
        <section id="pricing" className="max-w-6xl mx-auto px-6 py-20">
          ...
          <div className="grid md:grid-cols-3 gap-8 items-center max-w-5xl mx-auto">
            ...
            <div className="p-8 rounded-3xl bg-white/5 border border-white/10">
              <h3 className="font-bold text-xl text-white mb-2">Free Starter</h3>
              <p className="text-slate-400 text-sm mb-6">Perfect to test the waters</p>
              <div className="mb-8"><span className="text-4xl font-bold text-white">₹0</span></div>
              <ul className="space-y-4 mb-8 text-sm text-slate-300">
                <li className="flex items-center gap-3"><CheckCircle2 className="w-4 h-4 text-emerald-400" /> 1 Resume Template</li>
                <li className="flex items-center gap-3"><CheckCircle2 className="w-4 h-4 text-emerald-400" /> Limited AI Generations</li>
                <li className="flex items-center gap-3 text-slate-500"><XCircle className="w-4 h-4" /> Watermarked PDF</li>
                <li className="flex items-center gap-3 text-slate-500"><XCircle className="w-4 h-4" /> Locked Mock Tests</li>
              </ul>
            ...
            <div className="p-8 rounded-3xl bg-gradient-to-b from-blue-900/40 to-[#070710] border border-blue-500/50 relative shadow-[0_0_30px_rgba(59,130,246,0.2)] md:-mt-8 md:mb-8">
              <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-blue-500 text-white text-xs font-bold uppercase tracking-widest py-1 px-3 rounded-full">Most Popular</div>
              <h3 className="font-bold text-xl text-white mb-2">Pro Pass</h3>
              <p className="text-slate-400 text-sm mb-6">Everything you need to get hired</p>
              <div className="mb-2 flex items-baseline gap-1"><span className="text-5xl font-bold text-white">₹29</span><span className="text-slate-400 text-sm">/one-time</span></div>
              <p className="text-xs text-blue-400 font-bold mb-6">Valid for 30 Days</p>
              <ul className="space-y-4 mb-8 text-sm text-slate-300">
                <li className="flex items-center gap-3"><CheckCircle2 className="w-4 h-4 text-blue-400" /> Clean, Watermark-Free PDF</li>
                <li className="flex items-center gap-3"><CheckCircle2 className="w-4 h-4 text-blue-400" /> Full AI JD Matching</li>
                <li className="flex items-center gap-3"><CheckCircle2 className="w-4 h-4 text-blue-400" /> All Resume Templates</li>
                <li className="flex items-center gap-3"><CheckCircle2 className="w-4 h-4 text-blue-400" /> Public Web Portfolio</li>
                <li className="flex items-center gap-3"><CheckCircle2 className="w-4 h-4 text-blue-400" /> Unlock Mock Tech Interviews</li>
              </ul>
              <Link href="/signup" className="block w-full py-3 px-4 bg-blue-600 hover:bg-blue-500 text-white text-center rounded-xl font-bold transition-colors shadow-lg shadow-blue-500/25">Upgrade to Pro</Link>
            </div>

            {/* Unlimited Tier */}
            <div className="p-8 rounded-3xl bg-white/5 border border-white/10">
              <h3 className="font-bold text-xl text-white mb-2">Unlimited</h3>
              <p className="text-slate-400 text-sm mb-6">For aggressive job hunting</p>
              <div className="mb-8 flex items-baseline gap-1"><span className="text-4xl font-bold text-white">₹199</span><span className="text-slate-400 text-sm">/month</span></div>
              <ul className="space-y-4 mb-8 text-sm text-slate-300">
                <li className="flex items-center gap-3"><CheckCircle2 className="w-4 h-4 text-purple-400" /> Everything in Pro</li>
                <li className="flex items-center gap-3"><CheckCircle2 className="w-4 h-4 text-purple-400" /> Unlimited AI Generations</li>
                <li className="flex items-center gap-3"><CheckCircle2 className="w-4 h-4 text-purple-400" /> Unlimited ATS Scans</li>
                <li className="flex items-center gap-3"><CheckCircle2 className="w-4 h-4 text-purple-400" /> Priority Support</li>
              </ul>
              <Link href="/signup" className="block w-full py-3 px-4 bg-white/5 hover:bg-white/10 text-white text-center rounded-xl font-bold transition-colors border border-white/10">Get Unlimited</Link>
            </div>
          </div>
        </section>
