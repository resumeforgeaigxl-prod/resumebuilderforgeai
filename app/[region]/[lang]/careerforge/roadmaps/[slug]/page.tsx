...
export default function RoadmapView() {
    ...
    if (!roadmap) return (
        <div className="min-h-[70vh] flex flex-col items-center justify-center">
            ...
            <Link href={`/${region}/${lang}/careerforge/roadmaps`} className="text-indigo-400 mt-4 underline">Back to Explorer</Link>
        </div>
    );
    ...
    return (
        <div className="max-w-5xl mx-auto py-12 px-6 space-y-16 pb-32">
            ...
            <div className="space-y-8">
                <Link href={`/${region}/${lang}/careerforge/roadmaps`} className="inline-flex items-center gap-2 text-slate-500 hover:text-white transition-colors text-[10px] font-black uppercase tracking-[0.2em] group">
                                ...
                                {step.roadmap_skills.map((skill) => (
                                    ...
                                    >
                                        ...
                                        {skill.learning_topic ? (
                                            <Link
                                                href={`/${region}/${lang}/careerforge/library/${skill.learning_topic.language_slug}/${skill.learning_topic.slug}`}
