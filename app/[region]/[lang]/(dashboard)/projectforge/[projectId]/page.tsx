...
export default function ProjectViewer() {
    const params = useParams() as { region: string; lang: string; projectId: string };
    const { region, lang, projectId } = params;
    ...
    useEffect(() => {
        const fetchProject = async () => {
            try {
                ...
                console.error(err);
                router.push(`/${region}/${lang}/projectforge`);
            } finally {
                setLoading(false);
            }
        };
