    ...
    if (error || !document) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] bg-[#030308] text-center p-8">
                ...
                <Link href={`/${region}/${lang}/studyforge`} className="px-6 py-2 bg-white/5 border border-white/10 rounded-xl text-indigo-400 font-bold hover:bg-white/10 transition-all">
                    Return to Library
                </Link>
            </div>
        );
            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                <div className="h-16 border-b border-white/5 flex items-center justify-between px-6 bg-[#070710]/80">
                    <div className="flex items-center gap-4">
                        <Link href={`/${region}/${lang}/studyforge`} className="p-2 hover:bg-white/5 rounded-xl text-slate-400 transition-all">
