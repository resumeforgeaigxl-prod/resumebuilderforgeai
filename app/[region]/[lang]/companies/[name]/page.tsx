...
export default function CompanyJobsPage({ params }: { params: { region: string; lang: string, name: string } }) {
    const company = params.name.split('-').join(' ');
    return (
        <div className="min-h-screen bg-[#070710] pt-20">
            ...
            <PublicJobBoard region={params.region} lang={params.lang} initialRole={company} />
        </div>
    );
}
