    ...
    return (
        <div className="space-y-12 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                {TOOLS.map((tool) => (
                    <Link key={tool.id} href={tool.href} className="group flex flex-col h-full bg-slate-900/40 border border-white/5 rounded-[3rem] p-8 hover:bg-slate-900/60 transition-all duration-500 hover:-translate-y-2 relative overflow-hidden">
                        {/* Background Glow */}
